...
class AppColors {
  static const Color AppBAr_BAR_END = Color(0xFFfab40d);
  static const Color AppBAr_BAR_BEGIN = Color(0xFFe95737);

  static const Color STATUS_BAR_COLOR = Color(0xFFf97d27);
  static const Color TITLE_BAR_COLOR = Color(0xFF4D1544);
  static const Color ACCENT_COLOR = Color(0xFFe95737);
  ...
  static const Color TEXT_COLOR = Color(0xFF4D1544);
  ...
  static const Color LIGHT_ORANGE = Color(0xFFfab40d);
  static const Color DARK_ORANGE = Color(0xFFe95737);
}
